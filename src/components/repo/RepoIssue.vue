        ...
        <el-table-column label='详细信息' type='expand' width='100'>
          <template #default='scope'>
            <el-descriptions column='2' style='padding: 0 3rem'>
              <el-descriptions-item label='创建时间'>{{ new Date(scope.row.createdAt).toLocaleDateString() }}
              </el-descriptions-item>
              <el-descriptions-item label='修改时间'>{{ new Date(scope.row.updatedAt).toLocaleDateString() }}
              </el-descriptions-item>
